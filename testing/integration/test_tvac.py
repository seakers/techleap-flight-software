...
# --> Module Import
from Basilisk.ExternalModules import ImagerVNIR, DataStorage, FineNN, GimbalControl, InertialMeasurementUnit
...
def run(param1, param2):
    ...
    sim_client.new_c_module(vnir_module,    priority=4)
    ...
    sim_client.new_c_module(fine_module, priority=1)
    ...
    storage_module.ins_msg.subscribeTo(get_consumer_msg())
