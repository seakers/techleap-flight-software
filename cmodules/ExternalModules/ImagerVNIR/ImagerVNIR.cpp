...
void ImagerVNIR::UpdateState(uint64_t CurrentSimNanos) {
    ...
    redBand.ColInc = 4;
    redBand.RowInc = 4;
    byte* ptr = (byte*)pIStImage->GetImageBuffer();
